<script lang="ts">
    export let titolo: string, descrizione: string, image: string;
</script>
 
<a href="#9" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row max-w-xl hover:bg-gray-100">
